...
StockHub는 국내외 시장 뉴스와 핵심 지표를 한곳에서 빠르게 확인할 수 있도록 설계된 모바일 앱입니다. 투자 판단에 필요한 속보, 관심 키워드, 시장 흐름을 간결한 UI로 정리해 보여주며, 운영 정보와 정책 링크도 앱 내부 정보 화면과 동일한 구조로 제공합니다.
...
| 항목 | 링크 |
| --- | --- |
| 공식 안내 페이지 | https://imchic.github.io/stockhub-privacy/docs/index.html |
| 문의 페이지 | https://imchic.github.io/stockhub-privacy/docs/contact.html |
| 개인정보처리방침 | https://imchic.github.io/stockhub-privacy/docs/privacy_policy.html |
